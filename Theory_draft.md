...
The F0→F4 progression sweeps ~1→26 kPa — essentially the same mechanical range as our hydrogels (0.5–23 kPa; **Fig. 6A**). The in vitro axis and the in vivo disease axis are the *same physical variable*.
