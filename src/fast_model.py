...
def load_saturating_params(path="saturating_params.json"):
    ...
    Looks in the repository's data/ directory. Falls back to the hard-coded
    defaults if the file is not found, and merges so any phenotype missing from
    the JSON still resolves."""
