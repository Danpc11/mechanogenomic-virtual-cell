"""
================================================================================
 make_figures.py  —  Figures for the mechanogenomic cell model
================================================================================
...
def figure1():
    ...
    cdata = _json.load(open('hepatocyte_complete_data.json'))
    tp = pd.read_csv('hepatocyte_two_populations.csv')
...
# ============================================================================
def figure2():
    post = json.load(open('hepatocyte_posterior.json'))["parameters"]
    sat = json.load(open('saturating_params.json'))
